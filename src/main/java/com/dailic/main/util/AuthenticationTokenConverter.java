...
public class AuthenticationTokenConverter implements Converter<Jwt, JwtAuthenticationToken> {
    ...
    public JwtAuthenticationToken convert(Jwt source) {
        ...
        Map<String, Object> realmAccessMap = (Map<String, Object>) Optional
                .ofNullable(source.getClaimAsMap("realm_access"))
                .orElse(Collections.emptyMap());

        List<String> roles = (List<String>) realmAccessMap
        ...
        CustomUserPrincipal principal = new CustomUserPrincipal(
                userId, email, emailVerified, firstName, lastName, roles
        );
